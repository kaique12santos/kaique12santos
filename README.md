...
Olá! Sou o **Kaique**, desenvolvedor backend em formação pela **Fatec Zona Leste** (São Paulo/SP). Tenho experiência real com projetos acadêmicos de nível intermediário-avançado e atuo em dois papéis simultâneos na faculdade — o que me ensinou a equilibrar liderança técnica, comunicação e entrega sob pressão.

Apaixonado por **arquitetura de sistemas**, **boas práticas de código** e aquela sensação de ver uma API bem estruturada respondendo como deveria. 🎯
...
<table>
  <tr>
    <td width="50%">
      <h3>⚙️ Backend Lead & Project Leader</h3>
      <strong>SGPI · Fatec ZL</strong><br/>
      Liderei o desenvolvimento backend e a gestão do projeto SGPI — um sistema acadêmico desenvolvido em equipe. Responsável pela arquitetura, divisão de tarefas e revisão de código.
      <br/><br/>
      <code>Node.js</code> <code>Express</code> <code>MySQL</code> <code>REST API</code>
    </td>
    <td width="50%">
      <h3>📚 Monitor de Engenharia de Software</h3>
      <strong>Fatec ZL</strong><br/>
      Apoio a colegas em conteúdos de engenharia de software, processos de desenvolvimento e documentação técnica. Reforço de conceitos e suporte às aulas práticas.
      <br/><br/>
      <code>Documentação</code> <code>Metodologias Ágeis</code> <code>Comunicação Técnica</code>
    </td>
  </tr>
</table>
...
```
🧠  Pensamento analítico   →  Projeto antes de codar
🤝  Trabalho em equipe     →  2 anos de projetos colaborativos na Fatec
🎯  Foco em entrega        →  Monitor + Lead ao mesmo tempo, sem perder prazo
📖  Aprendizado contínuo   →  Sempre expandindo o stack
🗣️  Comunicação técnica    →  Experiência como monitor e tech lead
```
...
> 💡 *Estou em busca de oportunidades como estagiário ou desenvolvedor júnior — se tiver uma missão interessante, aceito o desafio!*
...
<div align="center">
  <sub>⚔️ Obrigado por visitar meu perfil — cada commit é um passo na jornada! ⭐</sub>
</div>
